    ...
    >
      ...
      <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={4}>
        <Box>
          <Typography
            variant="h4"
            sx={{ fontWeight: 600, color: "#282c3f", mb: 1, letterSpacing: "-0.5px" }}
          >
            {mode === "login" ? "Login" : "Sign up"}
          </Typography>
          <Typography variant="body2" sx={{ color: "#686b78", fontSize: "14px" }}>
            or{" "}
            <Box
              component="span"
      ...
      <Box component="form" noValidate sx={{ mt: 1 }}>
        ...
        >
          By {mode === "login" ? "clicking on Login" : "creating an account"}, I accept the{" "}
          <Box component="span" sx={{ color: "#282c3f", fontWeight: 600, cursor: "pointer" }}>
            Terms & Conditions
          </Box>{" "}
          &{" "}
          <Box component="span" sx={{ color: "#282c3f", fontWeight: 600, cursor: "pointer" }}>
